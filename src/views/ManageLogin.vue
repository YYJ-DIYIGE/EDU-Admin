        ...
        <div class="account-login-contaienr">
          <div class="account-login-bd">
            <div class="company-info-container">
              <span class="company-info-name">欢迎使用EDU Pro</span>
            </div>
            <div class="company-info-desc">管理员登录</div>
...
<script>
import Manage from "../gloabl/request/api";
      ...
      this.$refs[formName].validate(valid => {
        if (valid) {
          if (formName === "passwordFrom") {
            ...
            Manage.manageLogin({ phone, password }).then(res => {
              if (res.code == 201) {
                DataStoer.setToken(res.token);
                DataStoer.setUserInfo(res.userInfo);
